...
def check_events(ai_settings, screen, stats, play_button, sb, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, play_button, sb, ship, aliens, bullets,
                              mouse_x, mouse_y)


def check_play_button(ai_settings, screen, stats, play_button, sb, ship, aliens, bullets,
                      mouse_x, mouse_y):
    ...
    if button_clicked and not stats.game_active:
        ...
        # Сброс изображений счетов, уровня и кораблей
        sb.prep_score()
        sb.prep_level()
        sb.prep_high_score()
        sb.prep_ships()
...
def get_number_rows(ai_settings, ship_width, alien_width):
    ...
    available_space_x = (ai_settings.screen_width - (12 * alien_width) - ship_width)
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
    ...
    alien.rect.x = (ai_settings.screen_width - 2 * alien.rect.width) - \
                   (2 * alien.rect.width * row_number)
    aliens.add(alien)
...
def ship_hit(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        # Создание нового флота и размещение корабля у левого края
        create_fleet(ai_settings, screen, ship, aliens)
        ship.center_ship()
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    # Проверка пришельцев, добравшихся до левого края экрана
